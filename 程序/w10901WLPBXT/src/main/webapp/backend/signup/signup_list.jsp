          ...
          <tr>
            ...
            <table width="100%">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="list_title"> 报名信息列表</span></td>
              </tr>
            </table></td>
            <script>
  ...
  <tr>
    ...
    <thead>
      <tr>
        ...
        <th width="200" height="20"><div align="center"><span>报名时间</span></div></th>
        <th width="200" height="20"><div align="center"><span>参赛组别</span></div></th>
        <th width="200" height="20"><div align="center"><span>电话</span></div></th>
        <th width="200" height="20"><div align="center"><span>邮箱</span></div></th>
        <th width="200" height="20"><div align="center"><span>身份证号</span></div></th>
        <th width="200" height="20"><div align="center"><span>出生日期</span></div></th>
        <th style="display:none;" width="200" height="20"><div align="center"><span class="STYLE10">其他报名材料</span></div></th>
        <th width="200" height="20"><div align="center"><span>审核</span></div></th>
        <th width="200" height="20"><div align="center"><span>报名账号</span></div></th>
        <th width="200" height="20"><div align="center"><span>基本操作</span></div></th>
      </tr>
      </thead>
      <tbody>
      <c:if test="${not empty signupList}">
      <form id="form_signup_betch" method="post">
      <c:forEach items="${signupList}" var="signup">
<tr>
        <td height="20"><div align="center">
          <input type="checkbox" name="signupCheckbox" value="${signup.id }"/>
        </div></td>
        <td height="20"><div align="center">${signup.name }</div></td>
        <td height="20"><div align="center"><fmt:formatDate value="${signup.settime }" pattern="yyyy-MM-dd"/></div></td>
        <td height="20"><div align="center">初创组</div></td>
        <td height="20"><div align="center">${signup.tel }</div></td>
        <td height="20"><div align="center">${signup.email }</div></td>
        <td height="20"><div align="center">${signup.idno }</div></td>
        <td height="20"><div align="center">${signup.birthday }</div></td>
        <td style="display:none;"  height="20"><div align="center">${signup.content }</div></td>
        <td height="20"><div align="center">${signup.shenhe.name }</div></td>
        <td height="20"><div align="center">${signup.member.name }</div></td>
        <td height="20"><div align="center">
        <script>
...
<c:if test="${login_user.role.id eq '1'}">
        <a href="javascript:delconfirm('signup!delete?id=${signup.id }')" class="button_list2 " title="点击删除项目信息">删除</a><span class="shuxian"> |</span>
        <a href="javascript:opera('signup!modify?id=${signup.id }')" class="button_list2 " title="点击编辑项目信息">编辑</a><br/>
         <a href="javascript:opera('signup!modifyShenhe?id=${signup.id }')" class="button_list2 " title="点击编辑项目信息" class="button_list2 ">审核</a>
        <a href="javascript:opera('signup!show?id=${signup.id }')" class="button_list2 " title="点击查看详情">查看详情</a><br/>
</c:if>
<c:if test="${login_user.role.id eq '2'}">
        <a href="javascript:delconfirm('signup!delete?id=${signup.id }')" class="button_list2 " title="点击删除项目信息">删除</a><span class="shuxian"> |</span>
        <a href="javascript:opera('signup!modify?id=${signup.id }')" class="button_list2 "  title="点击编辑项目信息">编辑</a><br/>
