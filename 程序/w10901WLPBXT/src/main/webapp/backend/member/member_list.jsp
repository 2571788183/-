          ...
          <tr>
            ...
            <table width="100%">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="list_title"> 用户信息列表</span></td>
              </tr>
            </table></td>
            <script>
  ...
  <tr>
    ...
    <thead>
      <tr>
        ...
        <th width="200" height="20"><div align="center"><span>头像</span></div></th>
        ...
        <th width="200" height="20"><div align="center"><span>身份证</span></div></th>
...
<tr>
        ...
        <td height="20"><div align="center"><c:if test="${member.img ne '' and member.img ne '测试'}"><img src='upload_image/${member.img }' style='max-width:150px'/></c:if></div></td>
        <td height="20"><div align="center">${member.name }</div></td>
        <td height="20"><div align="center">${member.sex }</div></td>
        <td height="20"><div align="center"><fmt:formatDate value="${member.birthday }" pattern="yyyy-MM-dd"/></div></td>
        ...
        <td height="20"><div align="center"><c:if test="${member.idcardimg ne '' and member.idcardimg ne '测试'}"><img src='upload_image/${member.idcardimg }' style='max-width:150px'/></c:if></div></td>
...
<c:if test="${login_user.role.id eq '1'}">
        ...
        <a href="javascript:opera('member!modify?id=${member.id }')" class="button_list2 " title="点击编辑项目信息">编辑</a><br/>
         <a href="javascript:opera('member!modifyIdcardimg?id=${member.id }')" class="button_list2 " title="点击编辑项目信息" class="button_list2 ">身份证</a>
        <a href="javascript:opera('member!show?id=${member.id }')" class="button_list2 " title="点击查看详情">查看详情</a><br/>
</c:if>
<c:if test="${login_user.role.id eq '2'}">
        <a href="javascript:opera('member!modify?id=${member.id }')" class="button_list2 "  title="点击编辑项目信息">编辑</a><br/>
</c:if>
      ...
      <tr>
          <td height="20" colspan="90" class="noinfo"><div align="center">没有用户信息可以显示</div></td>
      </tr>
      </c:if>
      </tbody>
