...
<div id="formwrapper">
	...
	<fieldset>
		...
		<div>
			...
			<input type="hidden" name="img" id="img" value="${member.img }" size="60" maxlength="200" /> 
			<input type="file" style="display: none" name="uploadFile" id="imgUpload"  onchange="image('img',this)"/>
			<img id="img_image" style='max-width:150px;border:1px  solid #dddddd;padding:4px;border-radius:5px;' src="upload_image/${member.img }">
