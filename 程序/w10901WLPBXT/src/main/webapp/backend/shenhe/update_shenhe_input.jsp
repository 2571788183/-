...
<body>
<div id="formwrapper">
	<h3 class="add_title1">编辑报名审核</h3>
	<form action="shenhe!update?pageNo=${page.pageNo }&pageSize=${page.pageSize }" method="post">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="name" id="name" value="${shenhe.name }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="descp">备注</label>
			<input type="text" name="descp" id="descp" value="${shenhe.descp }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div class="enter">
