...
<body>
<div id="formwrapper">
    <h3 class="add_title1">添加赛道</h3>
    <form action="way!add" method="post">
        <fieldset>
            <legend class="add_title2">赛道信息</legend>
            <div>
                <label for="name">赛道名称</label>
                <input type="text" name="wayName" id="name" value="" size="60" maxlength="200"/>
                <br/>
            </div>

            <div>
                <label for="content">赛道介绍</label>
                <div style="margin:0px ;width:75%;display: inline-block;">
                    <textarea rows="10" cols="100" name="wayContent" id="content"></textarea>
                </div>
                <br/>
            </div>
